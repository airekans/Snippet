...
namespace zip_foreach {
  ...
  namespace __impl {
    ...
    template<typename Container>
      struct __IteratorTraits<const Container> {
    ...
    public:
      ...
      typedef typename __IteratorTraits<Container1>::iterator first_iterator;
      typedef typename __IteratorTraits<Container2>::iterator second_iterator;
  ...
  template<class Container1, class Container2>
    __impl::ZipContainer<Container1, Container2> zip(Container1& c1,
						     Container2& c2)
    {
